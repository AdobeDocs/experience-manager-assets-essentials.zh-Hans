...
1. 访问组织的[Admin Console](https://adminconsole.adobe.com)，单击顶部栏中的&#x200B;**[!UICONTROL 产品]**，单击&#x200B;**[!UICONTROL AEM Assets Essentials]**，然后单击[!DNL Assets Essentials]环境。[!DNL Assets Essentials] 有三个产品配置文件，分别代表管理员、常规和消费者用户的访问权限。
...
| 权限名称 | 描述 |
|-----|------|
| 可以查看 | <ul><li>具有查看和导航文件夹的读取权限 </li><li>预览资产</li><li>下载资源</li><li>复制资产</li><li>分享资产链接</li><ul> |
...
1. 从&#x200B;**[!UICONTROL 访问]**&#x200B;下拉列表中选择[访问级别](#manage-permissions-on-folders)。
...
1. 在&#x200B;**[!UICONTROL 管理权限]**&#x200B;对话框中，从&#x200B;**[!UICONTROL 访问]**&#x200B;下拉列表中编辑[访问级别](#manage-permissions-on-folders)。
...
* [观看视频，了解如何在Assets Essentials中管理权限](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/configuring/permissions-management.html?lang=zh-Hans)
