...
1. 在页面中间的搜索栏中键入资源名称，然后单击&#x200B;**[!UICONTROL 生成]**。
   ![Firefly 集成](firefly-integration.jpg)
...
* **监视**：[监视对资源执行的操作](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/search-assets)。
...
![上下文搜索示例1](/help/using/assets/contextual-search-example1.png)
...
![上下文搜索示例2](/help/using/assets/contextual-search-example2.png)
...
![上下文搜索示例3](/help/using/assets/contextual-search-example3.png)
...
![上下文搜索反馈](/help/using/assets/contextual-search-feedback.png)


## 后续步骤 {#next-steps}

* [观看视频，了解如何在 Assets Essentials 中搜索资源](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/using.html?lang=zh-Hans)
