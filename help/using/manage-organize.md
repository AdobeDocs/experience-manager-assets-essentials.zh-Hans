...
如果您的环境配置了具有 OpenAPI 功能的 Dynamic Media，Experience Manager Assets 就会在您将资产标记为 `Approved` 时立即生成一个公共 URL。
...
* [观看视频，了解如何在 Assets Essentials 中管理资产](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/managing.html?lang=zh-Hans)
