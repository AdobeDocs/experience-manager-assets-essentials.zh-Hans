...
* 将新资源与现有资源具有相同的文件名，并与现有资源位于同一文件夹中。[!DNL Assets Essentials] 提示覆盖以前的资源或将新资源另存为版本。 请参阅[上传重复的资源](/help/using/add-delete.md#resolve-upload-fails)。
...
通过 Assets Essentials 还可设置存储库中可用的资源的过期日期。 然后，可根据 `Expired` 资源状态[筛选搜索结果](search.md#refine-search-results)。 此外，还可指定资源的有效期限日期范围以进一步筛选搜索结果。
...
* [观看视频以管理Assets Essentials中的资源](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/managing.html?lang=zh-Hans)
