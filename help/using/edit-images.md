...
裁切的图像可供下载。 您可以将编辑后的资源另存为同一资源的新版本，也可以将其另存为新资源。
...
![Express 在 Essentials UI 上](/help/using/assets/express-in-essentials-ui.jpg)
要使用 Adobe Express 中嵌入的编辑器编辑图像，请按照以下步骤操作：
