...
>title="我的工作区"
>abstract="Assets 包括一个可自定义的工作区，此工作区提供各种小组件，以方便访问 Assets 用户界面的关键区域以及与您密切相关的信息。 此页面充当一个综合解决方案以提供您工作项的概述，并且通过它可快速地访问关键工作流。"
...
您还可以使用“我的工作区”的&#x200B;**洞察**&#x200B;部分查看在 Assets Essentials 部署中搜索最多的术语以及搜索这些术语的次数。 您还可以访问详细的洞察，以查看过去 30 天或 12 个月内的热门搜索。
