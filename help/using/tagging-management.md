...
description: 了解如何在“资产”视图中管理标记。 标记可帮助您对可以更高效地浏览和搜索的资源进行分类。
...
>title="管理标记"
>abstract="标记可帮助您对可以更高效地浏览和搜索的资源进行分类。 管理员可以使用分层标记结构，这有助于应用相关元数据、对资产进行分类、支持搜索、重用标记、提高可发现性等。"

标记可帮助您对可以更高效地浏览和搜索的资源进行分类。 标记有助于将相应的分类传播给其他用户和工作流。

随着时间的推移，受控词汇的平面列表可能会变得难以管理。 管理员可以使用分层标记结构，这有助于应用相关元数据、对资产进行分类、支持搜索、重用标记、提高可发现性等。
