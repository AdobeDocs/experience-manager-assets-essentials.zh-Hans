---
title: ' [!DNL Assets Essentials] 中的重命名和批量资产重命名'
description: 了解如何使用新的 Assets UI (Assets Essentials) 批量重命名资产。 它提供一次性重命名多个资产的功能。
role: User
...
1. 使用下述方法之一重命名资产或文件夹：
   ...
   * 选择资产或文件夹，然后点击顶部菜单中的![重命名图标](assets/do-not-localize/rename-icon.png) **[!UICONTROL 重命名]**。
...
1. [可选]点击![撤消图标](assets/do-not-localize/undo.svg)，撤消或取消您执行的上一个操作。

1. 在[!UICONTROL 新名称预览]一列中检查您的更改，然后点击&#x200B;**[!UICONTROL 保存]**。

   ![AI 批量重命名](assets/ai-bulk-rename.png)
