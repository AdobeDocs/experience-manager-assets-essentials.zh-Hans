...
| 如何发现资产？ | <ul> <li>[浏览存储库](/help/navigate-view.md#view-assets-and-details) </li> <li> [预览](/help/navigate-view.md#preview-assets) 资产 [并下载资产](/help/manage-organize.md#download) </li> <li>[搜索资产](/help/search.md)</li></ul> |
...
| 元数据操作 | <ul> <li>[查看详细元数据](/help/metadata.md) </li> <li> [创建新元数据表单](/help/metadata.md#metadata-forms) </li> </ul> |
